...
# 导入测试目标模块
try:
    from python_controller.medium_model import MediumModel
    from python_controller.model_orchestrator import (
        ModelOrchestrator,
        create_orchestrator,
        ModelTier,
    )
...
@unittest.skipUnless(MODULES_AVAILABLE, "架构模块不可用")
