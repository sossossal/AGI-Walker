...
def test_validation_description_type(temp_skills_dir):
    ...
    md_file = create_skill_file(temp_skills_dir, "bad-desc-list", """---
name: bad-desc-list
...
def test_validation_description_empty(temp_skills_dir):
    ...
    # Case 1: Empty string
    md_file = create_skill_file(temp_skills_dir, "empty-desc", """---
name: empty-desc
description: ""
---
""")
    ...
    md_file2 = create_skill_file(temp_skills_dir, "white-desc", """---
name: white-desc
description: "   "
---
""")
...
def test_validation_requires_element_type(temp_skills_dir):
    ...
    md_file = create_skill_file(temp_skills_dir, "bad-req-elem", """---
name: bad-req-elem
description: "valid"
metadata:
  agi_walker:
...
def test_validation_requires_is_list(temp_skills_dir):
    ...
    md_file = create_skill_file(temp_skills_dir, "bad-req-type", """---
name: bad-req-type
description: "valid"
metadata:
  agi_walker:
