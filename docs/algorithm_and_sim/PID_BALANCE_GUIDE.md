...
2. **`balance_controller.gd`** - 平衡控制器节�?

### Python�?
1. **`pid_controller.py`** - Python版PID控制�?
...
在Godot检查器中，�?`BalanceController` �?`debug_mode` 设为 `true`�?
查看实时平衡数据:
