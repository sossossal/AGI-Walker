...
AGI-Walker 的离线强化学习功能基�?**d3rlpy** 库，使用 **CQL (Conservative Q-Learning)** 算法�?

## 核心优势

- **样本效率提升 5-10 �?* - 充分利用已有数据
- **训练时间减少 50%+** - 无需大量在线探索
- **适合真实机器�?* - 避免危险的随机探�?
...
1. **数据质量很重�?* - 确保专家策略性能足够�?
2. **数据多样�?* - 收集不同场景和状态的数据
3. **CQL 超参�?* - `conservative_weight` 控制保守程度（默�?5.0�?
4. **Fine-tuning 必要�?* - 离线训练后通常需要少量在�?fine-tuning
