...
创建�?`physics_config.gd` 集中管理所有物理参数：
...
| | `FOOT_FRICTION` | 0.9 | 脚底摩擦�?|
| **关节** | `HIP_LIMIT_LOWER` | -45° | 髋关节下�?|
| | `HIP_LIMIT_UPPER` | 90° | 髋关节上�?|
| | `MOTOR_MAX_IMPULSE` | 500 N·m | 最大扭�?|
