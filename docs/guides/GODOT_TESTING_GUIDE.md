...
1. 在项目列表中找到 **"AGI-Walker"** �?**"godot_project"**
2. 双击打开
...
| 按键 | 功能 | 观察效果 |
|------|------|----------|
| **1** | 切换到地球环�?| 控制台显�?"🌍 切换到地球环�?，物体正常下�?|
| **2** | 切换到月球环�?| 控制台显�?"🌑 切换到月球环�?，物�?*缓慢**下落（低重力�?|
| **3** | 切换到火星环�?| 控制台显�?"🔴 切换到火星环�?，中等重�?|
| **C** | 切换到混凝土地面 | 控制台显�?"切换到混凝土地面"，地面颜色变为灰�?|
| **I** | 切换到冰�?| 控制台显�?"切换到冰�?，地面颜色变为浅蓝色，物体滑�?|
| **S** | 切换到沙�?| 控制台显�?"切换到沙�?，地面颜色变为黄褐色 |
...
**解决**:
- 可能是脚本路径问�?
- 检�?`res://scripts/environment/` 目录是否存在所有脚�?
- 检查控制台是否有红色错误信�?

### Q5: 插件无法启用

**解决**:
- 检�?`res://addons/robot_sim_toolkit/plugin.cfg` 是否存在
- 重启 Godot
...
- 添加子节�?�?`RigidBody3D`
- 给它添加 `CollisionShape3D` �?`MeshInstance3D`
- 设置不同的位�?
...
1. **实验更多参数** - 修改脚本中的数�?
2. **创建自己的机器人** - 参�?ADVANCED_USAGE.md
