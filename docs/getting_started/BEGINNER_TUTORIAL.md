...
### 1. 安装 Python
AGI-Walker 是基�?Python 开发的。如果您还没有安�?Python�?
1. 访问 [Python官网](https://www.python.org/downloads/)
2. 下载最新版�?(推荐 3.8 或以�?
3. 安装时务必勾�?**"Add Python to PATH"** (将Python添加到环境变�?
...
### 方法 B: 直接下载 ZIP
1. �?GitHub 页面点击绿色�?**"Code"** 按钮
2. 选择 **"Download ZIP"**
3. 解压下载的文�?
4. 在解压后的文件夹中打开命令�?(在文件夹地址栏输�?`cmd` 并回�?

---

## 📦 第二步：安装环境

我们需要安装一些必要的 Python �?(�?numpy, matplotlib �?�?
...
AGI-Walker 的核心是**参数化控�?*。让我们试着修改一下机器人的参数，看看会有什么不同�?
...
A: 请确保您已经成功运行�?`pip install -r requirements.txt`�?

**Q: 只有文字输出，没�?3D 画面�?*
A: 目前 AGI-Walker 主要专注�?*数据生成**�?*物理计算**。如果您需�?3D 画面，需要安�?Godot 引擎并运�?`godot_project` 目录下的工程�?

**Q: 如何控制机器人？**
A: 您不需要通过键盘控制它。这是一�?*仿真平台**，您通过修改代码中的参数来定义机器人的行为，然后观察它的表现�?

---

🎉 **恭喜！您已经成功入门 AGI-Walker�?*

现在您可以探�?`examples/` 目录下的其他脚本，发现更多有趣的功能�?
