...
| 部位 | 零件 | 数量 | 单价 | 小计 |
|------|------|------|------|------|
| 髋关�?(俯仰) | Dynamixel MX-106 | 2 | $489.9 | $979.8 |
| 髋关�?(偏航/滚转) | Dynamixel XL430 | 4 | $49.9 | $199.6 |
| 膝关�?| Dynamixel MX-106 | 2 | $489.9 | $979.8 |
| 踝关�?| Dynamixel XL430 | 4 | $49.9 | $199.6 |
| IMU | MPU6050 | 1 | $3.5 | $3.5 |
| 控制�?| IMC-22 × 12 | 12 | $40 | $480 |
| **总计** | - | - | - | **$2,842.3** |
...
reward = (
    ...
    - energy_consumption * 0.01    # 惩罚能�?
    + upright_bonus * 0.2          # 鼓励站立
)
```

**课程学习**:
1. 阶段 1: 学习站立�?00K steps�?
2. 阶段 2: 学习迈步�?00K steps�?
3. 阶段 3: 学习行走�?00K steps�?
