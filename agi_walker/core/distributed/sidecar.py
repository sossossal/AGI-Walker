...
class SmartSidecar:
    ...
    def __init__(self, actor_id, godot_port, zenoh_router):
        ...
        self.sub_act = self.session.declare_subscriber(self.key_act, self._on_cloud_action)
...
def main():
    ...
    parser.add_argument("--zenoh-router", type=str, default=os.environ.get("ZENOH_ROUTER"))
