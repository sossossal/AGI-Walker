...
class ParameterEstimator:
    ...
    """
    def __init__(self, num_params: int = 3, lambda_factor: float = 0.99, initial_p: float = 1000.0):
...
class GroundFrictionEstimator:
    ...
    def report(self):
        params = self.rls.get_params()
        logger.info(f"SysID Estimate: Damping={params[0]:.4f} | Friction={params[1]:.4f}")
