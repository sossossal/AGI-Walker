...
def upgrade() -> None:
    ...
    with op.batch_alter_table("workflow_runs", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("status_detail", sa.String(length=512), nullable=True))
        batch_op.add_column(
            sa.Column("cancel_requested", sa.Boolean(), nullable=False, server_default=sa.false())
        )
        batch_op.add_column(sa.Column("current_step_name", sa.String(length=128), nullable=True))
        batch_op.add_column(sa.Column("current_step_index", sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column("last_event", sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column("live_log_tail", sa.JSON(), nullable=True))
        batch_op.add_column(
            sa.Column("live_log_line_count", sa.Integer(), nullable=False, server_default="0")
        )
        batch_op.add_column(sa.Column("live_log_updated_at", sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column("live_log_path", sa.String(length=512), nullable=True))
        batch_op.add_column(sa.Column("live_log_download_url", sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column("log_path", sa.String(length=512), nullable=True))
        batch_op.add_column(sa.Column("log_download_url", sa.String(length=256), nullable=True))
        ...
        batch_op.add_column(
            sa.Column("preferred_godot_transport_mode", sa.String(length=64), nullable=True)
        )
        batch_op.add_column(sa.Column("progress_updated_at", sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column("step_errors", sa.JSON(), nullable=True))
        batch_op.add_column(sa.Column("failed_step_name", sa.String(length=128), nullable=True))
        batch_op.add_column(sa.Column("failed_step_error", sa.String(length=512), nullable=True))
        batch_op.add_column(sa.Column("diagnostic_summary", sa.String(length=1024), nullable=True))
