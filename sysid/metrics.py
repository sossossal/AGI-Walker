...
class Sim2RealScorer:
    ...
    def calculate_score(self, real_data: Dict[str, Any], sim_data: Dict[str, Any]) -> float:
        """
    ...
    def generate_report(self, real_data: Dict[str, Any], sim_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _compute_error(self, real_data, sim_data):
        ...
        for name in joint_names:
            r_vals = np.array([m["state"]["joints"][name] for m in real_measurements[:min_len]])
            s_vals = np.array([m["state"]["joints"][name] for m in sim_measurements[:min_len]])
