...
- Next-stage external evidence checklists use `next_stage_external_evidence_checklist.v1` to convert readiness blockers into operator-executable evidence items without changing the readiness pass/fail contract.
