...
- 2026-07-08: Accepted Alpine candidate vulnerability burn-down evidence: GitHub Actions run `28962518720` passed `security-preflight` with Python findings `0`, container findings `0`, unresolved findings `0`, accepted findings `0`, and security posture `ready`; obsolete Web Panel no-fix exceptions may be retired from the managed exception input.
