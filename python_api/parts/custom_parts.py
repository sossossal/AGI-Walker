...
class PartCustomizer:
    ...
    def create_sensor(
        self, name: str, sensor_type: str, params: Dict = None
    ) -> CustomSensor:
        """创建定制传感器"""
...
if __name__ == "__main__":
    ...
    motor = customizer.create_motor("my_motor", {"power": 500, "gear_ratio": 50})
    ...
    joint = customizer.create_joint(
        "my_joint", {"reduction_ratio": 100, "backlash": 0.05}
    )
