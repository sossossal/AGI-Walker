...
class RealtimeDashboard:
    ...
    def setup_plots(self):
        ...
        self.battery_text = self.ax_battery_gauge.text(
            0.5, 0.5, "100%", ha="center", va="center", fontsize=40, fontweight="bold"
        )
        ...
        self.temp_text = self.ax_temp_gauge.text(
            0.5, 0.5, "25°C", ha="center", va="center", fontsize=35, fontweight="bold"
        )
        ...
        self.warning_text = self.ax_warnings.text(
            0.05, 0.9, "", ha="left", va="top", fontsize=10, family="monospace"
        )

    def update_data(
        self, timestamp: float, energy: float, temp: float, velocity: float, safety: int
    ):
        """
        更新数据
